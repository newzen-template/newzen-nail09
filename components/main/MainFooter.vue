...
<template>
  <footer >
    ...
    <div :style="{backgroundColor: footerData.background_color}" class="text-center text-lg-start text-muted position-relative" >
       <!-- Section: Links  -->
      <section class="animation_up">
          <!-- Form -->
          <div style="margin-bottom: -100px !important;" :style="{backgroundColor: footerData.background_button}" class="my__container position-relative form text-center">
      ...
      <!-- Section: Links  -->
      <div class="text-start pd":style="{backgroundColor: footerData.background_footer}">
