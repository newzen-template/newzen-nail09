        ...
        <div v-if="block.form" class="row">
          ...
          >
            ...
            >
              ...
              <div v-if="listFilesComplete[key]" class="w-100"  style="margin-top:8px">
                <div
              ...
              <div v-if="listFilesUpload[key]" class="w-100">
                <div
