          ...
          >
            ...
            >
              ...
              <div
                ...
                style="border-radius: 1rem; border-style: dashed !important"
                class="w-100 py-5 bg-light rounded-2xl border border-secondary gap-3 d-grid"
              >
                <div class="d-grid gap-1">
                  ...
                  <span class="text-center text-secondary fs-4">{{
                    item.placehoder
                  }}</span>
                </div>
                <div class="grid gap-2 text-center">
                  <span class=" ">Drag and Drop your file here or </span>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <span
                      class="ms-2 bg-white rounded-circle text-dark fw-semibold d-flex justify-content-center align-items-center px-2 py-1 small"
                    >
                      100%
                    </span>
                  </div>
              ...
              <div v-if="listFilesUpload[key]" class="w-100" style="padding-left: 8px;padding-right: 20px;">
                <div
                  v-for="(file, index) in listFilesUpload[key].value"
                  :key="index + file?.size"
                  class="w-100 grid gap-1 mb-4"
                >
                        ...
                        <div class="relative" style="width: 24px; height: 24px">
                          ...
                          >
                            ...
                            <circle
                              ...
                              :stroke-dashoffset="
                                62.83 *
                                (1 - percentCompleteUploadFile[key].value / 100)
                              "
                              stroke-linecap="round"
                            ></circle>
                          </svg>
                  ...
                  <div
                    class="position-relative d-flex align-items-center justify-content-between gap-2 py-2"
                  >
                    <span
                      v-if="!statusUploadFile[key]?.value"
                      class="text-danger fs-4 fw-normal"
                      style="font-family: 'Inter'; line-height: 18px"
                    >
                    ...
                    <div
                      v-else
                      class="relative w-100 h-2.5 overflow-hidden rounded-3xl bg-gray-100"
                    >
                      <div
                        role="progressbar"
                        aria-valuenow="100"
                        aria-valuemin="0"
                        aria-valuemax="100"
                        style="background-color: rgb(13, 110, 253); height: 10px !important; overflow: hidden ; border-radius: 16px; width: 100%;position: relative;"
                        :style="{
                          width: percentCompleteUploadFile[key].value
                            ? `${percentCompleteUploadFile[key].value}%`
                            : '0%',
                        }"
                        class="d-flex h-100 items-center transition-all duration-100 ease-linear justify-center bg-indigo-600 text-white rounded-3xl"
                      ></div>
                    </div>
                    ...
                    >
                      <span
                        v-if="statusUploadFile[key]?.value"
                        class="ms-2 bg-white rounded-circle text-dark text-xs fw-medium d-flex justify-content-center align-items-center"
                        >{{
                          percentCompleteUploadFile[key].value
                            ? `${percentCompleteUploadFile[key].value}%`
                            : "0%"
...
.text-reset {
  display: flex;
  align-items: center;
  gap: 8px; /* Tạo khoảng cách giữa icon và text */
